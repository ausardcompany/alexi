...
Generated: 2026-09-22 11:05:35

## Summary
- kilocode: 301 commits, 396 files changed
- opencode: 6 commits, 73 files changed

## kilocode Changes (f47c29dfe..28680d812)
...
- c7af47f9e - update grok endpoint (Frank, 2026-08-13)
- 6c035e1fd - fix(core): preserve unicode in grep previews (#42356) (Kit Langton, 2026-08-13)
- ab7cbc808 - chore: generate (opencode-agent[bot], 2026-08-13)
- 62387f39d - fix(skills): Update global config path in documentation (#42337) (Aditya Sethi, 2026-08-13)
- 864889ab9 - docs: remove Ling 3.0 Tiny free model (#42314) (Jack, 2026-08-13)
- cc4b45612 - sync release versions for v1.18.18 (opencode, 2026-08-13)
...
- `packages/opencode/src/kilocode/tool/registry.ts` (+7, -1)
...
- `packages/kilo-jetbrains/backend/src/main/kotlin/ai/kilocode/backend/cli/KiloCliDataParser.kt` (+35, -0)
- `packages/kilo-jetbrains/backend/src/main/kotlin/ai/kilocode/backend/rpc/KiloAppRpcApiImpl.kt` (+6, -5)
- `packages/kilo-jetbrains/backend/src/main/kotlin/ai/kilocode/backend/rpc/KiloSessionRpcApiImpl.kt` (+12, -0)
- `packages/kilo-jetbrains/backend/src/main/kotlin/ai/kilocode/backend/rpc/KiloWorktreeRpcApiImpl.kt` (+22, -3)
...
- `packages/kilo-jetbrains/backend/src/test/kotlin/ai/kilocode/backend/cli/KiloCliDataParserTest.kt` (+94, -0)
- `packages/kilo-jetbrains/backend/src/test/kotlin/ai/kilocode/backend/rpc/KiloWorktreeRpcApiImplTest.kt` (+22, -0)
...
- `packages/kilo-jetbrains/backend/src/test/kotlin/ai/kilocode/backend/testing/MockCliServer.kt` (+34, -0)
...
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/SessionUi.kt` (+16, -2)
...
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/board/SessionBoardDialog.kt` (+3, -2)
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/controller/SessionController.kt` (+104, -0)
...
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/ui/ProgressPanel.kt` (+16, -5)
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/ui/SessionMessageListPanel.kt` (+15, -2)
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/ui/header/BackgroundAgentStrip.kt` (+457, -0)
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/ui/header/SessionHeaderPanel.kt` (+53, -84)
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/ui/header/Strip.kt` (+201, -0)
...
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/ui/UiStyle.kt` (+33, -25)
...
- `packages/kilo-jetbrains/frontend/src/main/resources/messages/KiloBundle.properties` (+22, -1)
...
- `packages/kilo-jetbrains/frontend/src/test/kotlin/ai/kilocode/client/session/ui/ProgressPanelTest.kt` (+17, -4)
- `packages/kilo-jetbrains/frontend/src/test/kotlin/ai/kilocode/client/session/ui/header/BackgroundAgentStripStressTest.kt` (+39, -0)
- `packages/kilo-jetbrains/frontend/src/test/kotlin/ai/kilocode/client/session/ui/header/BackgroundAgentStripTest.kt` (+606, -0)
...
- `packages/kilo-jetbrains/frontend/src/test/kotlin/ai/kilocode/client/testing/FakeSessionRpcApi.kt` (+29, -0)
...
- `packages/kilo-ui/src/components/message-part.tsx` (+98, -10)
- `packages/kilo-ui/src/components/tool-utils.test.ts` (+23, -1)
- `packages/kilo-ui/src/components/tool-utils.ts` (+15, -0)
...
- `packages/opencode/src/kilocode/session/compaction-chunks.ts` (+6, -12)
...
- `packages/opencode/src/session/compaction.ts` (+66, -20)
...
- `packages/opencode/src/session/revert.ts` (+9, -4)
- `packages/opencode/src/session/session.ts` (+9, -11)
...
- `packages/opencode/test/kilocode/session-compaction-chunks.test.ts` (+2, -0)
...
- `packages/opencode/test/session/compaction.test.ts` (+181, -5)
...
## opencode Changes (70a2469..fe3f3a4)
...
- `packages/web/src/content/docs/ar/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/bs/go.mdx` (+22, -4)
- `packages/web/src/content/docs/bs/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/da/go.mdx` (+22, -4)
- `packages/web/src/content/docs/da/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/de/go.mdx` (+22, -4)
- `packages/web/src/content/docs/de/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/es/go.mdx` (+22, -4)
- `packages/web/src/content/docs/es/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/fr/go.mdx` (+22, -4)
- `packages/web/src/content/docs/fr/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/go.mdx` (+22, -4)
- `packages/web/src/content/docs/it/go.mdx` (+22, -4)
- `packages/web/src/content/docs/it/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/ja/go.mdx` (+22, -4)
- `packages/web/src/content/docs/ja/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/ko/go.mdx` (+22, -4)
- `packages/web/src/content/docs/ko/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/nb/go.mdx` (+22, -4)
- `packages/web/src/content/docs/nb/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/pl/go.mdx` (+22, -4)
- `packages/web/src/content/docs/pl/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/pt-br/go.mdx` (+22, -4)
- `packages/web/src/content/docs/pt-br/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/ru/go.mdx` (+22, -4)
- `packages/web/src/content/docs/ru/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/th/go.mdx` (+22, -4)
- `packages/web/src/content/docs/th/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/tr/go.mdx` (+22, -4)
- `packages/web/src/content/docs/tr/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/zh-cn/go.mdx` (+22, -4)
- `packages/web/src/content/docs/zh-cn/zen.mdx` (+7, -0)
- `packages/web/src/content/docs/zh-tw/go.mdx` (+22, -4)
- `packages/web/src/content/docs/zh-tw/zen.mdx` (+7, -0)
