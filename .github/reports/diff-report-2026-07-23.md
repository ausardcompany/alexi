...
Generated: 2026-07-23 08:31:19

## Summary
- kilocode: 73 commits, 308 files changed
- opencode: 9 commits, 58 files changed

## kilocode Changes (3cab1bd2d..2d16c00dd)
...
- `packages/kilo-vscode/src/KiloProvider.ts` (+7, -6)
...
- `packages/opencode/src/kilo-sessions/attached-state.ts` (+11, -3)
- `packages/opencode/src/kilo-sessions/ingest-queue.ts` (+8, -0)
- `packages/opencode/src/kilo-sessions/kilo-sessions.ts` (+217, -44)
- `packages/opencode/src/kilo-sessions/remote-protocol.ts` (+9, -0)
- `packages/opencode/src/kilo-sessions/remote-sender.ts` (+161, -5)
- `packages/opencode/src/kilo-sessions/remote-ws.ts` (+392, -94)
...
- `packages/opencode/src/kilocode/session/prompt-queue.ts` (+61, -1)
...
- `packages/opencode/src/provider/provider.ts` (+27, -12)
...
- `packages/opencode/src/session/processor.ts` (+8, -2)
- `packages/opencode/src/session/prompt.ts` (+7, -1)
...
- `packages/opencode/test/kilocode/session-prompt-queue.test.ts` (+294, -0)
- `packages/opencode/test/kilocode/session-stream-watchdog.test.ts` (+2, -0)
- `packages/opencode/test/kilocode/sessions/attached-state.test.ts` (+25, -0)
- `packages/opencode/test/kilocode/sessions/ingest-queue.test.ts` (+68, -0)
- `packages/opencode/test/kilocode/sessions/remote-protocol.test.ts` (+56, -0)
- `packages/opencode/test/kilocode/sessions/remote-sender.test.ts` (+460, -3)
- `packages/opencode/test/kilocode/sessions/remote-ws.test.ts` (+1443, -35)
...
- `packages/sdk/js/src/v2/gen/types.gen.ts` (+291, -240)
- `packages/sdk/openapi.json` (+607, -519)
...
## opencode Changes (0a601cf..347510a)
...
#### Core (**/core/)
- `packages/core/package.json` (+1, -1)
- `packages/core/test/provider-mistral.test.ts` (+28, -0)
...
- `packages/app/src/utils/server-compat.test.ts` (+95, -0)
- `packages/app/src/utils/server-compat.ts` (+496, -0)
...
- `patches/@ai-sdk%2Fmistral@3.0.34.patch` (+84, -0)
