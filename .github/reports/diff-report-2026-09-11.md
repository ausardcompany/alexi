...
Generated: 2026-09-11 10:44:33

## Summary
- kilocode: 290 commits, 688 files changed
- opencode: 16 commits, 92 files changed

## kilocode Changes (a7a7690ca..4304a8691)

### Commits

- 4304a8691 - chore: update nix node_modules hashes (kilo-maintainer[bot], 2026-09-11)
- e9390caa9 - Merge pull request #14047 from Kilo-Org/fix-kilo-vscode-visual-regression-ci (Marius, 2026-09-11)
- 203f19f5d - fix(cli): keep PTY output and exit emitted before listeners attach (marius-kilocode, 2026-09-11)
- afde43079 - test(tui): wait for the question prompt to render before pressing keys (marius-kilocode, 2026-09-11)
- 38d4728e7 - chore: update kilo-vscode visual regression baselines (kilo-maintainer[bot], 2026-09-11)
- b8a8ae277 - chore(ci): use GitHub-hosted runner for visual regression (marius-kilocode, 2026-09-11)
- 3d04228b6 - release: v7.6.2 (kilo-maintainer[bot], 2026-09-10)
- 7f9347502 - Merge pull request #14013 from Kilo-Org/kilo-swarm-env-flag (Marius, 2026-09-10)
- cc08de15d - release: v7.6.1 (kilo-maintainer[bot], 2026-09-10)
- 27aeae541 - Merge pull request #14012 from Kilo-Org/benchmark-vscode-tool-rendering-performance (Marius, 2026-09-10)
- d2381d7ac - feat(cli): enable shared agent board via experimental env flag (marius-kilocode, 2026-09-10)
- a613498c2 - Merge pull request #13936 from Kilo-Org/fix/exclude-permission-wait-duration (Kirill Kalishev, 2026-09-10)
- c0e4d51f3 - perf(ui): avoid building collapsed tool card content on mount (marius-kilocode, 2026-09-10)
- 91101f31f - Merge pull request #14011 from Kilo-Org/perf/diff-card-render (Marius, 2026-09-10)
- ee6ff21e6 - perf(ui): defer diff parsing until tool cards expand (marius-kilocode, 2026-09-10)
- 8a544966c - Merge pull request #13932 from sylwester-liljegren/feat/agent-manager-notification-navigation (Marius, 2026-09-10)
- 83b580b11 - Merge pull request #14006 from Kilo-Org/allow-inline-model-referencing (Marius, 2026-09-10)
- 684fa6cdb - Merge pull request #14005 from Kilo-Org/perf/todowrite-render (Marius, 2026-09-10)
- ed3593684 - Merge pull request #14007 from Kilo-Org/perf/bash-render (Marius, 2026-09-10)
- d3142cb21 - fix(vscode): keep restored model references out of file attachments (marius-kilocode, 2026-09-10)
- c72fc2e56 - fix(vscode): keep deferred tool bodies lazy when memoizing (marius-kilocode, 2026-09-10)
- 546321e59 - fix(vscode): speed up bash tool card rendering (marius-kilocode, 2026-09-10)
- e9f18b744 - feat(vscode): reference a model inline in the prompt with @ (marius-kilocode, 2026-09-10)
- 2205cdb4e - perf(ui): render read-only todo checkbox without Kobalte (marius-kilocode, 2026-09-10)
- 73b549e55 - Merge pull request #14004 from Kilo-Org/veil-intelligence (Marius, 2026-09-10)
- 61d4a34e3 - fix(vscode): scope subagent avatar color transition to the task card (marius-kilocode, 2026-09-10)
- d878c8c85 - Merge pull request #14003 from Kilo-Org/fix-question-dialog-textarea-keybindings (Marius, 2026-09-10)
- 19538aece - Merge pull request #14002 from Kilo-Org/investigate-text-streaming-latency-reduction (Marius, 2026-09-10)
- 5d1e7a25e - fix(vscode): animate subagent avatar from loading shimmer to identity (marius-kilocode, 2026-09-10)
- 70f1f5394 - Merge pull request #13993 from Kilo-Org/friendly-jaborosa (Christiaan Arnoldus, 2026-09-10)
- 567fbfa0f - fix(vscode): flush pending streamed text when cadence slows (marius-kilocode, 2026-09-10)
- 7c23a3e93 - fix(tui): submit and cancel custom answers in the question dialog (marius-kilocode, 2026-09-10)
- 8d5cae684 - fix(vscode): render streamed text at frame cadence (marius-kilocode, 2026-09-10)
...
- 35c487f72 - fix(vscode,jetbrains): pause working timer while waiting for permission or question (kirillk, 2026-09-08)
- 4bb09b125 - feat(vscode): round subagent avatars with sibling colors and live shimmer (marius-kilocode, 2026-09-08)
- 74740a43e - fix(agent-manager): avoid needless project reactivation and reveal Local sessions (Sylwester Liljegren, 2026-09-08)
- a508228b4 - feat(agent-manager): open notification Show in Agent Manager for its sessions (Sylwester Liljegren, 2026-09-08)
...
- `packages/opencode/src/kilocode/tool/board.ts` (+41, -16)
...
- `packages/opencode/src/kilocode/tool/registry.ts` (+21, -17)
- `packages/opencode/src/kilocode/tool/task.ts` (+0, -1)
- `packages/opencode/src/tool/registry.ts` (+2, -2)
- `packages/opencode/src/tool/shell.ts` (+1, -1)
- `packages/opencode/src/tool/task.ts` (+0, -1)
- `packages/opencode/test/kilocode/tool/memory-save.test.ts` (+1, -1)
- `packages/opencode/test/kilocode/tool/notify-user.test.ts` (+2, -2)
- `packages/opencode/test/kilocode/tool/send-file.test.ts` (+4, -3)
- `packages/opencode/test/tool/task.test.ts` (+0, -1)

#### Agent System (packages/*/src/agent/)
- `packages/opencode/src/agent/agent.ts` (+3, -7)
- `packages/opencode/src/kilocode/agent/index.ts` (+11, -7)
...
- `packages/core/src/kilocode/pty/latch.ts` (+40, -0)
- `packages/core/src/pty/driver.ts` (+1, -1)
- `packages/core/src/pty/pty.bun.ts` (+5, -2)
- `packages/core/test/kilocode/board/migration.test.ts` (+39, -0)
- `packages/core/test/kilocode/pty-latch.test.ts` (+36, -0)
...
- `.changeset/pty-early-output.md` (+5, -0)
- `.github/workflows/visual-regression.yml` (+4, -2)
...
- `packages/kilo-jetbrains/frontend/src/main/kotlin/ai/kilocode/client/session/ui/ProgressPanel.kt` (+48, -8)
...
- `packages/kilo-jetbrains/frontend/src/test/kotlin/ai/kilocode/client/session/ui/ProgressPanelTest.kt` (+60, -0)
...
- `packages/kilo-ui/src/components/agent-avatar.css` (+105, -0)
- `packages/kilo-ui/src/components/agent-avatar.tsx` (+66, -0)
- `packages/kilo-ui/src/components/basic-tool.css` (+22, -106)
- `packages/kilo-ui/src/components/basic-tool.tsx` (+8, -2)
...
- `packages/kilo-ui/src/components/message-part.tsx` (+294, -168)
...
- `packages/kilo-ui/src/components/tool-utils.test.ts` (+86, -0)
- `packages/kilo-ui/src/components/tool-utils.ts` (+99, -7)
...
- `packages/kilo-vscode/CHANGELOG.md` (+131, -0)
...
- `packages/kilo-vscode/src/agent-manager/AgentManagerProvider.ts` (+29, -37)
...
- `packages/kilo-vscode/src/agent-manager/reveal-session.ts` (+94, -0)
...
- `packages/kilo-vscode/src/agent-manager/worktree-file-path.ts` (+35, -0)
- `packages/kilo-vscode/src/extension.ts` (+36, -1)
...
- `packages/kilo-vscode/tests/unit/agent-manager-reveal-session.test.ts` (+136, -0)
...
- `packages/kilo-vscode/tests/unit/basic-tool-render.test.ts` (+4, -0)
...
- `packages/kilo-vscode/tests/unit/file-mention-utils.test.ts` (+30, -2)
...
- `packages/kilo-vscode/tests/unit/session-timing.test.ts` (+39, -0)
- `packages/kilo-vscode/tests/unit/use-file-mention.test.ts` (+115, -1)
- `packages/kilo-vscode/tests/unit/use-slash-command.test.ts` (+27, -0)
- `packages/kilo-vscode/tests/unit/working-indicator.test.ts` (+12, -6)
- `packages/kilo-vscode/tests/unit/worktree-create.test.ts` (+57, -0)
- `packages/kilo-vscode/tests/unit/worktree-file-path.test.ts` (+51, -0)
- `packages/kilo-vscode/tests/unit/worktree-manager.test.ts` (+20, -0)
- `packages/kilo-vscode/webview-ui/agent-manager/AgentManagerApp.tsx` (+47, -25)
...
- `packages/kilo-vscode/webview-ui/src/components/chat/MessageList.tsx` (+41, -14)
...
- `packages/kilo-vscode/webview-ui/src/components/chat/PromptInput.tsx` (+318, -98)
...
- `packages/kilo-vscode/webview-ui/src/components/chat/TaskToolExpanded.tsx` (+40, -6)
...
- `packages/kilo-vscode/webview-ui/src/components/shared/ModelSelector.tsx` (+64, -33)
...
- `packages/kilo-vscode/webview-ui/src/components/shared/WorkingIndicator.tsx` (+35, -23)
- `packages/kilo-vscode/webview-ui/src/components/shared/working-indicator-utils.ts` (+7, -2)
...
- `packages/kilo-vscode/webview-ui/src/context/session-timing.ts` (+21, -0)
- `packages/kilo-vscode/webview-ui/src/context/session-types.ts` (+7, -4)
- `packages/kilo-vscode/webview-ui/src/context/session.tsx` (+154, -61)
- `packages/kilo-vscode/webview-ui/src/hooks/file-mention-utils.ts` (+18, -1)
- `packages/kilo-vscode/webview-ui/src/hooks/useFileMention.ts` (+92, -4)
...
- `packages/kilo-vscode/webview-ui/src/stories/chat.stories.tsx` (+146, -5)
...
- `packages/kilo-vscode/webview-ui/src/stories/tool-call-lab.stories.tsx` (+1, -1)
...
- `packages/kilo-vscode/webview-ui/src/styles/prompt-dropdowns.css` (+14, -0)
...
- `packages/kilo-vscode/webview-ui/src/styles/tool-overrides.css` (+110, -0)
...
- `packages/kilo-vscode/webview-ui/src/types/messages/extension-messages.ts` (+38, -0)
...
- `packages/opencode/src/kilocode/board/context.ts` (+11, -1)
- `packages/opencode/src/kilocode/board/enabled.ts` (+13, -0)
...
- `packages/opencode/src/session/prompt.ts` (+85, -34)
...
- `packages/opencode/test/kilocode/board-context.test.ts` (+2, -0)
- `packages/opencode/test/kilocode/board-enabled.test.ts` (+65, -0)
- `packages/opencode/test/kilocode/board-tools.test.ts` (+69, -7)
- `packages/opencode/test/kilocode/board/store.test.ts` (+174, -0)
- `packages/opencode/test/kilocode/chart-tool-gating.test.ts` (+1, -1)
...
- `packages/opencode/test/kilocode/notebook-tools.test.ts` (+5, -2)
...
- `packages/opencode/test/kilocode/system-prompt.test.ts` (+1, -1)
- `packages/opencode/test/kilocode/task-nesting.test.ts` (+0, -7)
- `packages/opencode/test/kilocode/test-profile.test.ts` (+0, -1)
- `packages/opencode/test/kilocode/tool-registry-indexing.test.ts` (+56, -47)
...
- `packages/tui/src/routes/session/question.tsx` (+8, -1)
...
- `packages/tui/test/cli/tui/question-custom-answer.test.tsx` (+206, -0)
...
- `packages/ui/src/components/basic-tool.tsx` (+31, -11)
- `patches/bun-pty@0.4.8.patch` (+15, -0)
...
index 33ee44eef..abc52ee64 100644
...
## opencode Changes (d6855b6..193de13)

### Commits

- 193de13 - fix(stats): normalize deepseek v4.1 flash (Adam, 2026-09-10)
- 43e89ea - fix(stats): prevent full retention sync timeouts (Adam, 2026-09-10)
- b7ca4f9 - docs(go): update DeepSeek V4.1 Flash model ID (#48363) (Jack, 2026-09-11)
...
- `packages/stats/core/src/domain/inference.test.ts` (+61, -5)
- `packages/stats/core/src/domain/inference.ts` (+6, -7)
- `packages/stats/core/src/domain/model-normalization.ts` (+1, -0)
- `packages/stats/core/src/r2-sql.test.ts` (+18, -0)
- `packages/stats/core/src/r2-sql.ts` (+27, -13)
- `packages/stats/core/src/stat-sync.ts` (+44, -6)
...
- `src/core/` - review core changes from packages/core/src/kilocode/pty/latch.ts
- `src/core/` - review core changes from packages/core/src/pty/driver.ts
- `src/core/` - review core changes from packages/core/src/pty/pty.bun.ts
- `src/core/` - review core changes from packages/core/test/kilocode/board/migration.test.ts
- `src/core/` - review core changes from packages/core/test/kilocode/pty-latch.test.ts
