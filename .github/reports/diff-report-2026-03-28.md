...
Generated: 2026-03-28 07:00:45

## Summary
- kilocode: 68 commits, 89 files changed
- opencode: 37 commits, 199 files changed

## kilocode Changes (121f6e3c..eeebbd26)
...
## opencode Changes (7715252..6c14ea1)
...
- `packages/opencode/package.json` (+22, -22)
...
- `packages/opencode/src/cli/cmd/tui/app.tsx` (+183, -183)
...
- `packages/opencode/src/cli/cmd/tui/component/prompt/index.tsx` (+40, -12)
...
- `packages/opencode/src/cli/cmd/tui/context/theme.tsx` (+132, -110)
...
- `packages/opencode/src/cli/cmd/tui/routes/session/index.tsx` (+6, -16)
- `packages/opencode/src/cli/cmd/tui/routes/session/sidebar.tsx` (+25, -278)
- `packages/opencode/src/cli/cmd/tui/routes/session/subagent-footer.tsx` (+109, -0)
...
- `packages/opencode/src/session/compaction.ts` (+336, -247)
- `packages/opencode/src/session/index.ts` (+490, -383)
- `packages/opencode/src/session/llm.ts` (+4, -13)
- `packages/opencode/src/session/message-v2.ts` (+14, -6)
- `packages/opencode/src/session/prompt.ts` (+38, -29)
...
- `packages/opencode/test/session/compaction.test.ts` (+381, -1)
