...
Generated: 2026-05-21 09:42:24

## Summary
- kilocode: 184 commits, 552 files changed
- opencode: 0 commits, 0 files changed

## kilocode Changes (4c0e6987b..637c61e0a)
...
- `packages/kilo-jetbrains/README.md` (+69, -4)
- `packages/kilo-jetbrains/backend/build.gradle.kts` (+21, -1)
...
- `packages/kilo-jetbrains/build-tasks/src/main/kotlin/normalization/NormalizeOpenApiSpecConfig.kt` (+24, -0)
- `packages/kilo-jetbrains/build-tasks/src/main/kotlin/normalization/NormalizeOpenApiSpecTask.kt` (+31, -0)
- `packages/kilo-jetbrains/build-tasks/src/main/kotlin/normalization/OpenApiSpecNormalizer.kt` (+115, -0)
- `packages/kilo-jetbrains/build-tasks/src/test/kotlin/normalization/OpenApiSpecNormalizerTest.kt` (+90, -0)
...
- `packages/kilo-vscode/script/local-bin.ts` (+4, -0)
...
- `packages/opencode/CHANGELOG.md` (+18, -0)
...
- `packages/opencode/src/config/config.ts` (+42, -53)
...
- `packages/opencode/src/plugin/codex.ts` (+8, -5)
...
- `packages/opencode/src/server/routes/instance/httpapi/public.ts` (+6, -0)
...
- `packages/opencode/test/session/prompt.test.ts` (+71, -3)
...
index 9f1fd76ff..62a15b68f 100644
...
## opencode Changes (2339aac..7d5e91b)
