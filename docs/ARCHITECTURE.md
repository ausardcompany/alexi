...
| CLI Utilities | `src/cli/utils/` | Shared utilities: clipboard (cross-platform copy with fallback using browser globals), keybindings, model picker, autocomplete, colors |
...
│   ├── cli/            # CLI program + TUI (Ink/React components) + utils (clipboard, keybindings)
