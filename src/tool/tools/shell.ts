/**
 * Shell Tool - Execute shell commands in a persistent shell session
 * Based on upstream kilocode shell tool refactor
 * Renamed from bash for better cross-platform support
 */
...
// Export bash as an alias for backward compatibility
