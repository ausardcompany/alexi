 ...
 * Cross-platform shell execution supporting bash, zsh, fish, PowerShell, and cmd
 */
...
import { createShellId } from './shell/id.js';
import { detectShell, getShellEnv } from './shell/prompt.js';
...
// Export shell-related utilities
export { createShellId } from './shell/id.js';
export { detectShell, getShellPromptConfig, formatPrompt } from './shell/prompt.js';
