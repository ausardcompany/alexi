...
CRITICAL: Identify and preserve ALL explicit user instructions, preferences, and constraints verbatim. This includes:
- Coding style rules (indentation, naming, formatting)
- File/directory restrictions ("never modify X", "always edit Y")
- API endpoints, keys, or configuration values provided by the user
- Any "always do X" or "never do Y" directives
- Project-specific conventions or requirements stated by the user

Place these in a "## User Instructions" section at the top of your summary. These MUST survive compaction unchanged.
