...
import { ErrorWithCause, mergeIgnoreCase, pickValueIgnoreCase, removeLeadingSlashes, removeTrailingSlashes } from '@sap-cloud-sdk/util';
...
function mergeWithDefaultRequestConfig(apiVersion, resourceGroup, requestConfig) {
    ...
    const mergedHeaders = mergeIgnoreCase(defaultConfig.headers, requestConfig?.headers);
